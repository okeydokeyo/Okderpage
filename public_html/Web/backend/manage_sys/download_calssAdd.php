...
$arry=SoloSql("download_tags"," 1 order by `DB_DowTagSort` desc");
...
if(!empty($DB_DowTagSort) && !empty($DB_DowTagSubject) ){
	...
	ChangeSortAdd("download_tags","$DB_DowTagSort","DB_DowTagSort","");

	$UpStr=" `DB_DowTagSort`,`DB_DowTagSubject`,`DB_DowTagAnnounce`,`DB_AddTime`,`DB_EditUser`";
	$UpStr2=" '$DB_DowTagSort','$DB_DowTagSubject','$DB_DowTagAnnounce',NOW(),'".$_SESSION['ManUser']."'";
	AddSql("download_tags","download_calss.php","新增成功!!",$UpStr,$UpStr2);

	//紀錄使用者資訊	
	$UpStr="`DB_RecUser`,`DB_RecIp`,`DB_RecSubject`,`DB_RecAccess`,`DB_RecAction`,`DB_RecTime`";
	$UpStr2="'".$_SESSION['ManUser']."','".$_SERVER['REMOTE_ADDR']."','檔案下載標籤','".$DB_DowTagSubject."','add',NOW()";
...
<!--menu_end-->
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td align="left" valign="middle" background="images/gray_02.gif" class="text_12px_01"><a href="id_info.php" class="link_01">首頁</a> >> 網頁選單管理 >> <a href="download_calss.php" class="link_01">檔案下載</a> >> <span class="text_12px_02"><strong>新增標籤</strong></span></td>
...
<form action="download_calssAdd.php" method="POST" enctype="multipart/form-data" name="form1" target="FormFrame">  
	  <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="5" class="text_12px_01">
		  ...
		  <tr>
			...
			<td width="85%" align="left" valign="top" class="border_02"><input name="DB_DowTagSort"  type="text" class="text_12px_01" id="DB_DowTagSort" size="3" value="<? echo $arry['DB_DowTagSort']+1;?>" /></td>
		  </tr>
		  <tr>
			...
			<td align="left" valign="top" class="border_02"><input name="DB_DowTagSubject"  type="text" class="text_12px_01" id="DB_DowTagSubject" size="50" /></td>
		  </tr>
		  <tr>
			...
			<td align="left" valign="top" class="border_02">
			  <input name="DB_DowTagAnnounce" type="radio" value="0" />
			  是
			  <input name="DB_DowTagAnnounce" type="radio" value="1" checked="checked" />
			  否</td>
		  </tr>
		</table>
