...
$arry=SoloSql("calendar_tags"," 1 order by `DB_CalTagSort` desc");
...
if(!empty($DB_CalTagSort) && !empty($DB_CalTagSubject) ){
	...
	ChangeSortAdd("calendar_tags","$DB_CalTagSort","DB_CalTagSort","");

	$UpStr=" `DB_CalTagSort`,`DB_CalTagSubject`,`DB_CalTagAnnounce`,`DB_AddTime`,`DB_EditUser`";
	$UpStr2=" '$DB_CalTagSort','$DB_CalTagSubject','$DB_CalTagAnnounce',NOW(),'".$_SESSION['ManUser']."'";
	AddSql("calendar_tags","calendar_calss.php","新增成功!!",$UpStr,$UpStr2);

	//紀錄使用者資訊	
	$UpStr="`DB_RecUser`,`DB_RecIp`,`DB_RecSubject`,`DB_RecAccess`,`DB_RecAction`,`DB_RecTime`";
	$UpStr2="'".$_SESSION['ManUser']."','".$_SERVER['REMOTE_ADDR']."','行事曆管理','".$DB_CalTagSubject."','add',NOW()";
...
<!--menu_end-->
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td align="left" valign="middle" background="images/gray_02.gif" class="text_12px_01"><a href="id_info.php" class="link_01">首頁</a> >> 網頁選單管理 >> <a href="calendar_calss.php" class="link_01">行事曆管理</a> >> <span class="text_12px_02"><strong>新增標籤</strong></span></td>
...
<form action="calendar_calssAdd.php" method="POST" enctype="multipart/form-data" name="form1" target="FormFrame">  
	  <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="5" class="text_12px_01">
		  ...
		  <tr>
			...
			<td width="85%" align="left" valign="top" class="border_02"><input name="DB_CalTagSort"  type="text" class="text_12px_01" id="DB_CalTagSort" size="3" value="<? echo $arry['DB_CalTagSort']+1;?>" /></td>
		  </tr>
		  <tr>
			...
			<td align="left" valign="top" class="border_02"><input name="DB_CalTagSubject"  type="text" class="text_12px_01" id="DB_CalTagSubject" size="50" /></td>
		  </tr>
		  <tr>
			...
			<td align="left" valign="top" class="border_02">
			  <input name="DB_CalTagAnnounce" type="radio" value="0" />
			  是
			  <input name="DB_CalTagAnnounce" type="radio" value="1" checked="checked" />
			  否</td>
		  </tr>
		</table>
