...
if( !empty($DB_MadBack) ){		
    //新增			
    $UpStr = "`note`='".$DB_MadBack."'";			
    EditSql("comments", "$MesID", "`DB_MesID`", "message_calss.php", "備註更改成功!",$UpStr);
}
...
<!--menu_end-->
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td align="left" valign="middle" background="images/gray_02.gif" class="text_12px_01"><a href="id_info.php" class="link_01">首頁</a> >> 網頁選單管理 >> 留言版 >> <span class="text_12px_02"><strong>備註</strong></span></td>
...
<form action="message_calssNote.php" method="POST" enctype="multipart/form-data" name="form1" target="FormFrame">		  
		  <tr>
              <td align="left" valign="top" class="border_02">
                <img src="images/icon_g.gif" width="5" height="5" align="absmiddle" /> 備註
              </td>
			<td align="left" valign="top" class="border_02">
                <textarea name="DB_MadBack" cols="100" rows="10" class="text_12px_01"> 
                    <?php 
                    $result = mysql_query("SELECT * FROM comments WHERE DB_MesID=".$_GET['DB_MesID'].""); 
