...
if ( confirm("是否刪除此筆紀錄") ){
    location.href='links_del.php?chkdel=YES&DB_BanID='+id+'&page='+page;
}
}
...
<!--menu_end-->
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td align="left" valign="middle" background="images/gray_02.gif" class="text_12px_01"><a href="id_info.php" class="link_01">首頁</a> >> 網頁首頁管理 >> 相關連結 >> <span class="text_12px_02"><strong>連結列表</strong></span></td>
	...
	<table width="752" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		<td height="10" colspan="3" align="left" valign="top"><div align="right" style="padding:5px;margin:5px">
		  <a href="links_add.php" class="button_04">+新增資料</a></div></td>
	  </tr>
	</table>
	<table width="752" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	  ...
	  <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#cccccc">
		  <tr bgcolor="#f1f1f1">
			...
			<td width="43%" align="center">名稱 / 網址</td>
		...
		?>
		  <tr bgcolor="#ffffff">
			<td align="center"><? echo iron_give_zero("2",$return[$i]['DB_BanSort']);?></td>
			<td align="center"><a href="<? echo $return[$i]['DB_BanUrl'];?>" target="_blank"><img src="../file/<? echo $return[$i]['DB_BanImg'];?>" width="142" height="48" border="0" align="top" id="border_02" /></a></td>
			<td align="left"><span class="text_12px_03"><? echo $return[$i]['DB_BanSubject'];?></span><br /><? echo $return[$i]['DB_BanUrl'];?></td>
			<td align="center"><a href="links_edit.php?DB_BanID=<? echo $return[$i]['DB_BanID'];?>&page=<? echo $page;?>" class="button_02"><img src="images/icon_edit.gif" border="0" align="absmiddle" /> 編輯</a>&nbsp;<a href="javascript:Delete(<? echo $return[$i]['DB_BanID'];?>,<? echo $page;?>);" class="button_03"><img src="images/icon_del2.gif" border="0" align="absmiddle" /> 刪除</a></td>
		  </tr>
		<? $i++;
		}
		}else{
