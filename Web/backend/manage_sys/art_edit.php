	  ...
	  <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="5" class="text_12px_01">
		  ...
		  <tr>
			...
			<td width="85%" align="left" valign="top" class="border_02"><input name="DB_ArtSort"  type="text" class="text_12px_01" id="DB_ArtSort" value="<? echo $arry['DB_ArtSort'];?>" size="3" />
			<input  type="hidden" name="DB_ArtSort_no" value="<? echo $arry['DB_ArtSort'];?>"></td>
		  </tr>
		  <tr>
			...
			<td width="85%" align="left" valign="top" class="border_02">
			  <input name="DB_ArtAnnounce" type="radio" value="0" <? if($arry['DB_ArtAnnounce']=="0"){echo "checked";}?>/>顯示
			  <input name="DB_ArtAnnounce" type="radio" value="1" <? if($arry['DB_ArtAnnounce']=="1"){echo "checked";}?> />不顯示</td>
		  </tr>
		  <tr>
			...
			<td align="left" valign="top" class="border_02"><input name="DB_ArtSubject"  type="text" class="text_12px_01" id="DB_ArtSubject" value="<? echo $arry['DB_ArtSubject'];?>" size="80" maxlength="12" /></td>
		  </tr>
		  <tr>
			...
			<td align="left" valign="top" class="border_02">
              ...
              <option value="1" <? if($arry['DB_ArtBasis']=="1"){echo "selected";}?>>內容頁面</option>
              <option value="2" <? if($arry['DB_ArtBasis']=="2"){echo "selected";}?>>連結附件</option>
              <option value="3" <? if($arry['DB_ArtBasis']=="3"){echo "selected";}?>>連結網址</option>
              </select></td>
		  </tr>
		</table>
			<span id="OpenDIV_1" style="display:<? if($arry['DB_ArtBasis']=="1"){echo "block";}else{echo "none";}?>">		
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="text_12px_01">
              <tr>
		  ...
		  ?>
              ...
              <tr>
                ...
                <td align="left" valign="top" class="border_02"><textarea name="DB_ArtYou_1" cols="50" rows="5" class="text_12px_01" id="DB_ArtYou_1"><? echo $arry['DB_ArtYou_1'];?></textarea>
					<input name="DB_ArtYouLocation_1" type="radio" value="1" <? if($arry['DB_ArtYouLocation_1']=="1"){echo "checked";}?> />
					放置內容上方
					<input name="DB_ArtYouLocation_1" type="radio" value="2" <? if($arry['DB_ArtYouLocation_1']=="2"){echo "checked";}?> />
					放置內容下方
                </td>
              </tr>
              <tr>
                <td align="left" valign="top" class="border_02"><img src="images/icon_g.gif" width="5" height="5" align="absmiddle" /> 嵌入YouTube(2)</td>
                <td align="left" valign="top" class="border_02"><textarea name="DB_ArtYou_2" cols="50" rows="5" class="text_12px_01" id="DB_ArtYou_2"><? echo $arry['DB_ArtYou_2'];?></textarea>
					<input name="DB_ArtYouLocation_2" type="radio" value="1" <? if($arry['DB_ArtYouLocation_2']=="1"){echo "checked";}?> />
					放置內容上方
					<input name="DB_ArtYouLocation_2" type="radio" value="2" <? if($arry['DB_ArtYouLocation_2']=="2"){echo "checked";}?> />
					放置內容下方</td>
              </tr>
              <tr>
                <td align="left" valign="top" class="border_02"><img src="images/icon_g.gif" width="5" height="5" align="absmiddle" /> 嵌入YouTube(3)</td>
                <td align="left" valign="top" class="border_02"><textarea name="DB_ArtYou_3" cols="50" rows="5" class="text_12px_01" id="DB_ArtYou_3"><? echo $arry['DB_ArtYou_3'];?></textarea>
					<input name="DB_ArtYouLocation_3" type="radio" value="1" <? if($arry['DB_ArtYouLocation_3']=="1"){echo "checked";}?> />
					放置內容上方
					<input name="DB_ArtYouLocation_3" type="radio" value="2" <? if($arry['DB_ArtYouLocation_3']=="2"){echo "checked";}?> />
					放置內容下方</td>
              </tr>
			  <tr>
			...
			?>
			<a href="../file/<? echo $arry['DB_ArtImg_1'];?>" target="_blank"><? echo $arry['DB_ArtFileName_1'];?></a> <a href="javascript:change_file1(<? echo $arry['DB_ArtID'];?>,'DB_ArtImg_1');"><img src="images/icon_del.gif" width="16" height="16" border="0" align="absmiddle" /></a>
			<? 
			...
			<input name="DB_ArtLocation_1" type="radio" value="1" <? if($arry['DB_ArtLocation_1']=="1"){echo "checked";}?>/>
			放置內容上方
			<input name="DB_ArtLocation_1" type="radio" value="2" <? if($arry['DB_ArtLocation_1']=="2"){echo "checked";}?>/>
			放置內容下方</td>
		      </tr>
			  <tr>
			...
			?>
			<a href="../file/<? echo $arry['DB_ArtImg_2'];?>" target="_blank"><? echo $arry['DB_ArtFileName_2'];?></a> <a href="javascript:change_file2(<? echo $arry['DB_ArtID'];?>,'DB_ArtImg_2');"><img src="images/icon_del.gif" width="16" height="16" border="0" align="absmiddle" /></a>
			<? 
			...
			<input name="DB_ArtLocation_2" type="radio" value="1" <? if($arry['DB_ArtLocation_2']=="1"){echo "checked";}?>/>
			放置內容上方
			<input name="DB_ArtLocation_2" type="radio" value="2" <? if($arry['DB_ArtLocation_2']=="2"){echo "checked";}?>/>
			放置內容下方</td>
		      </tr>
			  <tr>
			...
			?>
			<a href="../file/<? echo $arry['DB_ArtImg_3'];?>" target="_blank"><? echo $arry['DB_ArtFileName_3'];?></a> <a href="javascript:change_file3(<? echo $arry['DB_ArtID'];?>,'DB_ArtImg_3');"><img src="images/icon_del.gif" width="16" height="16" border="0" align="absmiddle" /></a>
			<? 
			...
			<input name="DB_ArtLocation_3" type="radio" value="1" <? if($arry['DB_ArtLocation_3']=="1"){echo "checked";}?>/>
			放置內容上方
			<input name="DB_ArtLocation_3" type="radio" value="2" <? if($arry['DB_ArtLocation_3']=="2"){echo "checked";}?>/>
			放置內容下方</td>
		      </tr>
			  <tr>
			    ...
			    <td width="85%" align="left" valign="top" class="border_02">
				  <input name="DB_ArtUrl_1" type="text" class="text_12px_01" id="DB_ArtUrl_1" value="<? echo $arry['DB_ArtUrl_1'];?>" size="40" />
			      名稱：
		          <input name="DB_ArtUrlName_1" type="text" class="text_12px_01" id="DB_ArtUrlName_1" value="<? echo $arry['DB_ArtUrlName_1'];?>" size="40" /></td>
			  </tr>
			  <tr>
			    ...
			    <td width="85%" align="left" valign="top" class="border_02">
				  <input name="DB_ArtUrl_2" type="text" class="text_12px_01" id="DB_ArtUrl_2" value="<? echo $arry['DB_ArtUrl_2'];?>" size="40" />
			      名稱：
		          <input name="DB_ArtUrlName_2" type="text" class="text_12px_01" id="DB_ArtUrlName_2" value="<? echo $arry['DB_ArtUrlName_2'];?>" size="40" /></td>
			  </tr>
			  <tr>
			    ...
			    <td width="85%" align="left" valign="top" class="border_02">
				  <input name="DB_ArtUrl_3" type="text" class="text_12px_01" id="DB_ArtUrl_3" value="<? echo $arry['DB_ArtUrl_3'];?>" size="40" />
			      名稱：
		          <input name="DB_ArtUrlName_3" type="text" class="text_12px_01" id="DB_ArtUrlName_3" value="<? echo $arry['DB_ArtUrlName_3'];?>" size="40" /></td>
			  </tr>
			  <tr>
			...
			?>
			<a href="download.php?DB_FileTitle=<? echo urlencode($arry['DB_ArtName_1']);?>&DB_FileName=<? echo $arry['DB_ArtArchive_1'];?>"><? echo $arry['DB_ArtName_1'];?></a> <a href="javascript:change_file4(<? echo $arry['DB_ArtID'];?>,'DB_ArtArchive_1');"><img src="images/icon_del.gif" width="16" height="16" border="0" align="absmiddle" /></a>
			<? 
			...
			?>
			<a href="download.php?DB_FileTitle=<? echo urlencode($arry['DB_ArtName_2']);?>&DB_FileName=<? echo $arry['DB_ArtArchive_2'];?>"><? echo $arry['DB_ArtName_2'];?></a> <a href="javascript:change_file5(<? echo $arry['DB_ArtID'];?>,'DB_ArtArchive_2');"><img src="images/icon_del.gif" width="16" height="16" border="0" align="absmiddle" /></a>
			<? 
			...
			?>
			<a href="download.php?DB_FileTitle=<? echo urlencode($arry['DB_ArtName_3']);?>&DB_FileName=<? echo $arry['DB_ArtArchive_3'];?>"><? echo $arry['DB_ArtName_3'];?></a> <a href="javascript:change_file6(<? echo $arry['DB_ArtID'];?>,'DB_ArtArchive_3');"><img src="images/icon_del.gif" width="16" height="16" border="0" align="absmiddle" /></a>
			<? 
			...
			<span id="OpenDIV_2" style="display:<? if($arry['DB_ArtBasis']=="2"){echo "block";}else{echo "none";}?>">  		
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="text_12px_01">
              <tr>
		...
		?>
		<a href="download.php?DB_FileTitle=<? echo urlencode($arry['DB_ArtName2_1']);?>&DB_FileName=<? echo $arry['DB_ArtArchive2_1'];?>"><? echo $arry['DB_ArtName2_1'];?></a> <a href="javascript:change1(<? echo $arry['DB_ArtID'];?>,'DB_ArtArchive2_1');"><img src="images/icon_del.gif" width="16" height="16" border="0" align="absmiddle" /></a>
		<? 
		...
		<? }?>
			...
			<span id="OpenDIV_3" style="display:<? if($arry['DB_ArtBasis']=="3"){echo "block";}else{echo "none";}?>">   		
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="text_12px_01">
              <tr>
			    ...
			    <td width="85%" align="left" valign="top" class="border_02">
				<input name="DB_ArtUrl3_1" type="text" class="text_12px_01" id="DB_ArtUrl3_1" value="<? echo $arry['DB_ArtUrl3_1'];?>" size="40" />
				  </td>
			  </tr>
			</table>
			</span>
	    ...
	    <input  type="hidden" name="DB_ArtID_no" value="<? echo $_GET['DB_ArtID'];?>">
		</td>
