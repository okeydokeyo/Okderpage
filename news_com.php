		  ...
		  <td align="left" valign="middle" class="border_02 text_12px_01-2">
			<p>
			   <?php if ( $arry1['DB_OrdImg_1'] != "" && $arry1['DB_OrdLocation_1'] == "1"){?>
				   <img src="backend/file/<?php echo $arry1['DB_OrdImg_1']?>" alt="<?php echo $arry1['DB_OrdFileName_1'];?>" width="400" />
			   <?php }?>
			   <?php if ($arry1['DB_OrdImg_2'] != "" && $arry1['DB_OrdLocation_2'] == "1"){?>
				   <img src="backend/file/<?php echo $arry1['DB_OrdImg_2']?>" alt="<?php echo $arry1['DB_OrdFileName_2'];?>" width="400" />
			   <?php }?>
			   <?php if ($arry1['DB_OrdImg_3'] != "" && $arry1['DB_OrdLocation_3'] == "1"){?>
				   <img src="backend/file/<?php echo $arry1['DB_OrdImg_3']?>" alt="<?php echo $arry1['DB_OrdFileName_3'];?>" width="400" />
			   <?php }?>
			</p>
			<p>
