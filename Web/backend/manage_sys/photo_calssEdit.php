...
$DB_LifTagID = $_POST['LifTagID'];
$DB_LifTagSort = $_POST['DB_LifTagSort'];
$LifTagSort = $_POST['LifTagSort'];
...
if( !empty($DB_LifTagSort) && !empty($DB_LifTagSubject) ){
	                ...
	                ChangeSortEdit("life_tags",$DB_LifTagSort,"DB_LifTagSort",$LifTagSort,""); //修改排序
	    
				    //修改
					$UpStr = "`DB_LifTagSort`='$DB_LifTagSort',`DB_LifTagSubject`='$DB_LifTagSubject',`DB_LifTagAnnounce`='$DB_LifTagAnnounce',`DB_EndTime`=NOW(),`DB_EditUser`='".$_SESSION['ManUser']."'";
					EditSql("life_tags",$DB_LifTagID,"DB_LifTagID","photo_calss.php","修改成功!!",$UpStr);
			
					//紀錄使用者資訊	
					$UpStr="`DB_RecUser`,`DB_RecIp`,`DB_RecSubject`,`DB_RecAccess`,`DB_RecAction`,`DB_RecTime`";
					$UpStr2="'".$_SESSION['ManUser']."','".$_SERVER['REMOTE_ADDR']."','網路相簿','".$DB_LifTagSubject."','edit',NOW()";
...
<!--menu_end-->
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td align="left" valign="middle" background="images/gray_02.gif" class="text_12px_01"><a href="id_info.php" class="link_01">首頁</a> >> 網頁選單管理 >> <a href="photo_calss.php" class="link_01">網路相簿</a> >> <span class="text_12px_02"><strong>編輯標籤</strong></span></td>
	...
	<table width="752" border="0" cellspacing="0" cellpadding="0">
<form action="photo_calssEdit.php" method="POST" name="form1" target="FormFrame">	  
	  <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="5" class="text_12px_01">
		  ...
		  <tr>
			...
			<td width="85%" align="left" valign="top" class="border_02">
			   <input name="DB_LifTagSort" value="<? echo $ary['DB_LifTagSort'];?>" type="text" class="text_12px_01" size="3" maxlength="3"/>
			   <input type="hidden" name="LifTagSort" value="<? echo $ary['DB_LifTagSort'];?>" />
			   <input type="hidden" name="LifTagID" value="<? echo $ary['DB_LifTagID'];?>" />
			</td>
		  </tr>
		  <tr>
			...
			<td align="left" valign="top" class="border_02"><input name="DB_LifTagSubject" value="<? echo $ary['DB_LifTagSubject'];?>" type="text" class="text_12px_01" size="50" /></td>
		  </tr>
		  <tr>
			...
			<td align="left" valign="top" class="border_02">
			  <input name="DB_LifTagAnnounce" type="radio" value="0" <? if ($ary['DB_LifTagAnnounce'] == "0"){echo "checked";}?>/>是
			  <input name="DB_LifTagAnnounce" type="radio" value="1" <? if ($ary['DB_LifTagAnnounce'] == "1"){echo "checked";}?>/>否</td>
		  </tr>
		</table>
