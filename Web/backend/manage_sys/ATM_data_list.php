...
function  Delete(id,page){
  if ( confirm("是否刪除此筆紀錄") ){
      location.href='ATM_data_del.php?chkdel=YES&num='+id+'&page='+page;
  }
}
...
<!--menu_end-->
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td align="left" valign="middle" background="images/gray_02.gif" class="text_12px_01"><a href="id_info.php" class="link_01">首頁</a> >> 我要捐款管理 >> <span class="text_12px_02"><strong>線上ATM捐款管理</strong></span></td>
	...
	<table width="752" border="0" cellspacing="0" cellpadding="0">
	  ...
	  ?>
		  <tr bgcolor="#ffffff">
			...
			<td align="left" class="text_12px_03"><? echo $return[$i]['name_1'];?></td>
			<td align="center"><? echo $chk_data;?></td>
			<td align="center"><a href="ATM_data_edit.php?no=<? echo $return[$i]['num'];?>&page=<? echo $page;?>" class="button_02"><img src="images/icon_edit.gif" border="0" align="absmiddle" /> 編輯</a>&nbsp;<a href="javascript:Delete(<? echo $return[$i]['num'];?>,<? echo $page;?>);" class="button_03"><img src="images/icon_del2.gif" border="0" align="absmiddle" /> 刪除</a></td>
		  </tr>
	  <? 
				 $i++;
					}
