...
<form action="indextop_edit.php" method="POST" enctype="multipart/form-data" name="form1" target="FormFrame">	
	...
	<table width="752" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		...
		<td width="742" align="top" valign="middle" class="title_bg"><strong><? echo $ary2['DB_TopTagSubject'];?></strong></td>
		<td width="5" align="top" valign="top"><img src="images/title_bg03.gif" width="5" height="28" /></td>
	  </tr>
	  <tr>
		<td height="10" colspan="3" align="top" valign="top"><div align="right" style="padding:5px;margin:5px"><a href="indextop_list.php?DB_TopTagID=<? echo $_GET['DB_TopTagID'];?>" class="button_01">◎回列表頁</a></div></td>
	  </tr>
	</table>
	<table width="752" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		<td align="top" valign="top" style="background-image:url(images/com_L.gif); background-repeat:repeat-y;">&nbsp;</td>
  ...
  <tr>
    <td height="10" colspan="2" align="top" valign="top"></td>
  </tr>
</table>
