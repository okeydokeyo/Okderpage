...
<form action="toplogo_edit.php" method="POST" enctype="multipart/form-data" name="form1" target="FormFrame">	  
	  ...
	  <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="5" class="text_12px_01">
		  ...
		  <tr>
			...
			<td align="left" valign="top" class="border_02"><input name="DB_LogExp" value="<? echo $arry['DB_LogExp'];?>" type="text" class="text_12px_01" size="80" /></td>
		  </tr>
		  <tr>
	...
	?>
	<a href="../file/<? echo $arry['DB_LogImg'];?>" target="_blank"><? echo $arry['DB_LogFileName'];?></a> <a href="javascript:change1(<? echo $arry['DB_LogID'];?>,'DB_LogImg');"><img src="images/icon_del.gif" width="16" height="16" border="0" align="absmiddle" /></a>
	<? 
