...
<!--menu_end-->
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td align="left" valign="middle" background="images/gray_02.gif" class="text_12px_01"><a href="id_info.php" class="link_01">首頁</a> >> 網頁首頁管理 >> 上方選單管理 >> <span class="text_12px_02"><strong><? echo $ary['DB_TopTagSubject'];?></strong></span></td>
	...
	<table width="752" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		...
		<div align="right" style="padding:5px;margin:5px"><a href="indextop_calss.php" class="button_04">◎回標籤列表</a>&nbsp;<a href="indextop_add.php?DB_TopTagID=<? echo $ary['DB_TopTagID'];?>" class="button_04">+新增資料</a></div>
		</td>
	  </tr>
	</table>
	<table width="752" border="0" cellspacing="0" cellpadding="0">
  ...
  if($return){
		...
		while( $return[$i] ){
				   ...
				   if ($return[$i]['DB_TopBasis'] == "1"){
				   ...
				   }else if ($return[$i]['DB_TopBasis'] == "2"){
				           //說明文章類別查詢
				   ...
				   }else if ($return[$i]['DB_TopBasis'] == "3"){
				           //行事曆管理查詢                          
				   ...
				   }else if ($return[$i]['DB_TopBasis'] == "4"){
				           //檔案下載類別查詢
				   ...
				   }else if ($return[$i]['DB_TopBasis'] == "5"){
				           //網路相簿查詢
				   ...
				   }else if ($return[$i]['DB_TopBasis'] == "6"){
				           //常見問題管理查詢
				   ...
				   }else if ($return[$i]['DB_TopBasis'] == "7"){
				           //網站連結查詢
				           ...
				           $IBasis = "網站連結";				   
				   }else if ($return[$i]['DB_TopBasis'] == "8"){
				           //參訪紀錄查詢
		...
		?>					  
		  <tr bgcolor="#ffffff">
			<td align="center"><? echo $return[$i]['DB_TopSort'];?></td>
			<td align="center"><? echo $return[$i]['DB_TopSubject'];?></td>
			<td align="center" class="text_12px_03"><? echo $IBasis;?></td>
			<td align="center">
			    <a href="indextop_edit.php?DB_TopTagID=<? echo $ary['DB_TopTagID'];?>&DB_TopID=<? echo $return[$i]['DB_TopID'];?>" class="button_02"><img src="images/icon_edit.gif" border="0" align="absmiddle" /> 編輯</a>&nbsp;
