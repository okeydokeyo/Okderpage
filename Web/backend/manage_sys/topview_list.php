...
if ( confirm("是否刪除此筆紀錄") ){
    location.href='topview_del.php?chkdel=YES&DB_AniID='+id+'&page='+page;
}
}
...
<!--menu_end-->
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td align="left" valign="middle" background="images/gray_02.gif" class="text_12px_01"><a href="id_info.php" class="link_01">首頁</a> >> 網頁風格管理 >> <span class="text_12px_02"><strong>形象動畫管理</strong></span></td>
	...
	<table width="752" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		...
		<!--<span class="text_12px_01"><img src="images/arrow_orange_n.gif" width="10" height="11" align="absmiddle" /> 版本選擇</span>
		  ...
		  <a href="topview_add.php" class="button_04">+新增資料</a></div></td>
	  </tr>
	</table>
	<table width="752" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	  ...
	  <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#cccccc">
		  <tr bgcolor="#f1f1f1">
			...
			<td width="60%" align="center">形象圖片說明</td>
		...
		?>		  
		  <tr bgcolor="#ffffff">
			<td align="center"><? if($return[$i]['DB_AniID']=="1"){echo "預設";}else{?><? echo iron_give_zero("2",$return[$i]['DB_AniID']);?><? }?></td>
			<td align="left" class="text_12px_03"><? echo $return[$i]['DB_AniDescription'];?></td>
			<td align="center"><? echo $DB_AniAnnounce;?></td>
			<td align="center">
			  <a href="topview_edit.php?DB_AniID=<? echo $return[$i]['DB_AniID'];?>&page=<? echo $page;?>" class="button_02"><img src="images/icon_edit.gif" border="0" align="absmiddle" /> 編輯</a>
			  <? if($return[$i]['DB_AniID']!="1"){?><a href="javascript:Delete(<? echo $return[$i]['DB_AniID'];?>,<? echo $page;?>);" class="button_03"><img src="images/icon_del2.gif" border="0" align="absmiddle" /> 刪除</a><? }?>
			</td>
		  </tr>
		<? $i++;
		}
