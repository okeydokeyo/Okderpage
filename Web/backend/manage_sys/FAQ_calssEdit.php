...
$DB_FaqTagSort_no=$_POST['DB_FaqTagSort_no'];
...
if(!empty($DB_FaqTagSort) && !empty($DB_FaqTagSubject) ){
	...
	ChangeSortEdit("faq_tags","$DB_FaqTagSort","DB_FaqTagSort","$DB_FaqTagSort_no","");

	$UpStr=" `DB_FaqTagSort`='$DB_FaqTagSort',`DB_FaqTagSubject`='$DB_FaqTagSubject',`DB_FaqTagAnnounce`='$DB_FaqTagAnnounce',`DB_EndTime`=NOW(),`DB_EditUser`='".$_SESSION['ManUser']."'";
	EditSql("faq_tags","$DB_FaqTagID_no","DB_FaqTagID","FAQ_calss.php","修改成功!!",$UpStr);

	//紀錄使用者資訊	
	$UpStr="`DB_RecUser`,`DB_RecIp`,`DB_RecSubject`,`DB_RecAccess`,`DB_RecAction`,`DB_RecTime`";
	$UpStr2="'".$_SESSION['ManUser']."','".$_SERVER['REMOTE_ADDR']."','常見問題管理標籤','".$DB_FaqTagSubject."','edit',NOW()";
...
<!--menu_end-->
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td align="left" valign="middle" background="images/gray_02.gif" class="text_12px_01"><a href="id_info.php" class="link_01">首頁</a> >> 網頁選單管理 >> <a href="FAQ_calss.php" class="link_01">常見問題</a> >> <span class="text_12px_02"><strong>編輯標籤</strong></span></td>
...
<form action="FAQ_calssEdit.php" method="POST" enctype="multipart/form-data" name="form1" target="FormFrame">  
	  <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="5" class="text_12px_01">
		  ...
		  <tr>
			...
			<td width="85%" align="left" valign="top" class="border_02"><input name="DB_FaqTagSort"  type="text" class="text_12px_01" id="DB_FaqTagSort" value="<? echo $arry['DB_FaqTagSort'];?>" size="3" />
			<input  type="hidden" name="DB_FaqTagSort_no" value="<? echo $arry['DB_FaqTagSort'];?>"></td>
		  </tr>
		  <tr>
			...
			<td align="left" valign="top" class="border_02"><input name="DB_FaqTagSubject"  type="text" class="text_12px_01" id="DB_FaqTagSubject" value="<? echo $arry['DB_FaqTagSubject'];?>" size="50" /></td>
		  </tr>
		  <tr>
			...
			<td align="left" valign="top" class="border_02">
			  <input name="DB_FaqTagAnnounce" type="radio" value="0" <? if($arry['DB_FaqTagAnnounce']=="0"){echo "checked";}?>/>是
			  <input name="DB_FaqTagAnnounce" type="radio" value="1" <? if($arry['DB_FaqTagAnnounce']=="1"){echo "checked";}?> />否</td>
		  </tr>
		</table>
		<div align="center" style="padding:5px;margin:5px"><a href="javascript:document.form1.submit();" onClick="return checklat();" class="button_01">送出</a>&nbsp;<a href="#" onClick="" class="button_01">取消</a></div>
		<input  type="hidden" name="DB_FaqTagID_no" value="<? echo $_GET['DB_FaqTagID'];?>">
		</td>
