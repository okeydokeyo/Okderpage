...
function  Delete(id){
  if ( confirm("是否刪除此筆紀錄") ){
      location.href='sections_calssDel.php?chkdel=YES&DB_OrdTagID='+id;
  }
}
-->
</script>
...
<!--menu_end-->
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td align="left" valign="middle" background="images/gray_02.gif" class="text_12px_01"><a href="id_info.php" class="link_01">首頁</a> >> 網頁選單管理 >> <span class="text_12px_02"><strong>條列式訊息管理</strong></span></td>
	...
	<table width="752" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		...
		<!--<span class="text_12px_01"><img src="images/arrow_orange_n.gif" width="10" height="11" align="absmiddle" /> 版本選擇</span>
		  ...
		  <a href="sections_calssAdd.php" class="button_04">◎新增標籤</a></div></td>
	  </tr>
	</table>
	<table width="752" border="0" cellspacing="0" cellpadding="0">
	  <tr>
