...
if(!empty($DB_AniDescription) ){
    if(!empty($_FILES['DB_AniArchive_1']['name'])){
        $return=iron_upload("DB_AniArchive_1", time(), "", "../../videos/", "mp4", "16677216" );
        $UpStr=" `DB_AniAnnounce`='$DB_AniAnnounce',`DB_AniDescription`='$DB_AniDescription',`DB_AniArchive_1`='".$return['new_file']."',`DB_AniName_1`='".$return['old_file_name']."',`DB_EndTime`=NOW(),`DB_EditUser`='".$_SESSION['ManUser']."'";  
    }
	else{         
        $UpStr=" `DB_AniAnnounce`='$DB_AniAnnounce',`DB_AniDescription`='$DB_AniDescription',`DB_EndTime`=NOW(),`DB_EditUser`='".$_SESSION['ManUser']."'";        
    }
...
<script language="javascript">
    function checkinput(){
        ...
        if (document.form1.DB_AniArchive_1.value == ""){ErrString = ErrString + "上傳影片" + unescape('%0D%0A')}
        if (ErrString != "") {
            alert("您有以下欄位未確實填寫：\n\n"+ErrString+"\n請檢查您所填寫的資料。");
        return false;
        }
        ...
        <td width="752" align="left" valign="top">
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td align="left" valign="middle" background="images/gray_02.gif" class="text_12px_01">
                        <a href="id_info.php" class="link_01">首頁</a> >> 網頁風格管理 >> 主要影片管理 >> 
                ...
                <form action="topview_edit.php" method="POST" enctype="multipart/form-data" name="form1" target="FormFrame">	 
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
                            ...
                            <span id="OpenDIV_2" style="display:block">  	
                                <table width="100%" border="0" cellspacing="1" cellpadding="5" class="text_12px_01">
                                    <tr>
                                        <td width="15%" align="left" valign="top" class="border_02"><img src="images/icon_g.gif" width="5" height="5" align="absmiddle" /> 上 傳 影 片<font color="red">*</font>
                                        </td>
                                        <td width="85%" align="left" valign="top" class="border_02">
                                            <span id="file2">
                                                ...
                                                ?>
                                                <a href="../../videos/<? echo $arry['DB_AniArchive_1'];?>" target="_blank">
                                                    <? echo $arry['DB_AniName_1'];?>
                                                </a> 
                                                <a href="javascript:change1(<? echo $arry['DB_AniID'];?>,'DB_AniArchive_1');">
                                                ...
                                                //為空值
                                                else if(empty($arry['DB_AniArchive_1']) && empty($arry['DB_AniName_1'])){
                                                ?>
