	...
	<table width="752" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		...
		<!--<span class="text_12px_01"><img src="images/arrow_orange_n.gif" width="10" height="11" align="absmiddle" /> 版本選擇</span>
		  ...
		  <a href="links2_calssAdd.php" class="button_04">◎新增標籤</a></div></td>
	  </tr>
	</table>
	<table width="752" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	  ...
	  <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#cccccc">
		  ...
		  <tr bgcolor="#ffffff">
			...
			<td align="left"><a href="links2_list.php" class="link_04">標籤_01</a></td>
			<td align="center"><span class="state_edit">顯示</span></td>
			<td align="center"><a href="links2_calssEdit.php" class="button_02"><img src="images/icon_edit.gif" border="0" align="absmiddle" /> 編輯</a>&nbsp;<a href="links2_calssDel.php" class="button_03"><img src="images/icon_del2.gif" border="0" align="absmiddle" /> 刪除</a></td>

		  </tr>
		  <tr bgcolor="#ffffff">
			<td align="center">2</td>
			<td align="left"><a href="links2_list.php" class="link_04">標籤_02</a></td>
			<td align="center"><span class="state_edit">顯示</span></td>
			<td align="center"><a href="links2_calssEdit.php" class="button_02"><img src="images/icon_edit.gif" border="0" align="absmiddle" /> 編輯</a>&nbsp;<a href="links2_calssDel.php" class="button_03"><img src="images/icon_del2.gif" border="0" align="absmiddle" /> 刪除</a></td>
		  </tr>
		  <tr bgcolor="#ffffff">
			<td align="center">3</td>
			<td align="left"><a href="links2_list.php" class="link_04">標籤_03</a></td>
			<td align="center"><span class="state_del">不顯示</span></td>
			<td align="center"><a href="links2_calssEdit.php" class="button_02"><img src="images/icon_edit.gif" border="0" align="absmiddle" /> 編輯</a>&nbsp;<a href="links2_calssDel.php" class="button_03"><img src="images/icon_del2.gif" border="0" align="absmiddle" /> 刪除</a></td>
