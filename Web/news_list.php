...
?>		
        ...
        <?php if ($ordi_num <> 0){?> 
		  <td width="12%" align="center" valign="top" class="text_12px_06  border_02"><?php if ($return[$i]['DB_OrdNewTime'] != "0000-00-00"){echo $return[$i]['DB_OrdNewTime'];}else{echo "&nbsp;";}?></td>
        <?php } ?>		  
		  <td width="12%" align="center" valign="top" class="text_12px_06  border_02"><?php echo $return[$i]['DB_OrdTime'];?></td>
		  <td width="68%" align="left" valign="middle" class="border_02"><a href="<?php echo $newClass;?>" class="link_03" title="<?php echo $newName;?>" <?php echo $newOpen;?>><?php echo $return[$i]['DB_OrdSubject'];?></a></td>
		</tr>
		<tr>
