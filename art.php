...
<p>
			<p>
			   <?php if ( $arry['DB_ArtImg_1'] != "" && $arry['DB_ArtLocation_1'] == "1"){?>
				   <img src="backend/file/<?php echo $arry['DB_ArtImg_1']?>" alt="<?php echo $arry['DB_ArtFileName_1'];?>" width="400" height="300" />
			   <?php }?>
			   <?php if ($arry['DB_ArtImg_2'] != "" && $arry['DB_ArtLocation_2'] == "1"){?>
				   <img src="backend/file/<?php echo $arry['DB_ArtImg_2']?>" alt="<?php echo $arry['DB_ArtFileName_2'];?>" width="400" height="300" />
			   <?php }?>
			   <?php if ($arry['DB_ArtImg_3'] != "" && $arry['DB_ArtLocation_3'] == "1"){?>
				   <img src="backend/file/<?php echo $arry['DB_ArtImg_3']?>" alt="<?php echo $arry['DB_ArtFileName_3'];?>" width="400" height="300" />
			   <?php }?>
			</p>
			<p>
